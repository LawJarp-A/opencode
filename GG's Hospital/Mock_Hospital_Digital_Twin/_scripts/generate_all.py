"""
Master script to generate all hospital data
...
def main():
    print("\n" + "="*70)
    print(" "*15 + "MOCK HOSPITAL DIGITAL TWIN")
    print(" "*18 + "Data Generation Suite")
    print("="*70)
    print("\nThis script will generate a complete hospital data ecosystem")
    print("with 1000+ patients and all associated clinical data.\n")
    
    # List of scripts to run in order
    scripts = [
        ("generate_patients.py", "Patient Identity Data"),
        ("generate_clinical_history.py", "Clinical History Data"),
        ("generate_vitals.py", "Observations & Vitals Data"),
        ("generate_allergies_immunizations.py", "Allergies & Immunizations Data"),
        ("generate_medications.py", "Medications Data"),
        ("generate_lab_results.py", "Lab Results Data"),
        ("generate_imaging.py", "Imaging Data"),
        ("generate_surgery.py", "Surgery Records"),
        ("generate_appointments.py", "Appointments & Visits Data"),
        ("generate_billing.py", "Billing & Insurance Data"),
        ("generate_compliance.py", "Compliance & Consent Data"),
        ("generate_workflow.py", "Workflow & Admin Data"),
        ("generate_interop.py", "Interoperability Data"),
        ("generate_analytics.py", "Analytics & Reporting Data"),
    ]
    ...
    print("\n" + "="*70)
    print("Data Location: ../Mock_Hospital_Digital_Twin/")
    print("="*70)
    ...
    print("\n🎉 Mock Hospital Digital Twin is ready!")
    print("\nYou can now explore the generated data in:")
    print("  📁 /Users/gg/Documents/GG's Hospital/Mock_Hospital_Digital_Twin/")

def generate_readme():
    """Generate README for the dataset"""
    readme_content = """# Mock Hospital Digital Twin
