...
- `query_sales` - Sales and revenue data (use this for ROI/performance analysis)
...
**NEVER use `search_web` for**: Product data, sales data, campaign metrics, inventory, pricing, or ANY commerce data.
